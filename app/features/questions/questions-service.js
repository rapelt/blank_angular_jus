...
angular.module('questionsService', ['data'])
  .factory('QuestionsService', function ($q, $http, DataRepository, ServiceFilters) {
    ...
    return {
      getQuestions: function () {
        ...
        return $q.all(data).then(function (values) {
          ...
          var serviceFilteredBusinessActivities = ServiceFilters.filterByBusinessActivities(services);
